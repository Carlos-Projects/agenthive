...
async def modify_tool(tool_name: str, patch: dict) -> dict:
...
@app.get("/memory/read")
async def read_memory(key: str) -> dict:
...
async def execute_agent_action(agent_id: str, req: AgentExecuteRequest) -> dict:
...
async def collaborate(req: CollaborateRequest) -> dict:
...
async def internal_metadata() -> dict:
